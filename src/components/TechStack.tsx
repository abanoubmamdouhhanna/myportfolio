        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {categories.map((category, index) => (
              <div 
                key={index}
                className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-3 transition-all duration-500 border border-slate-100 hover:border-slate-200"
              >
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-8 text-center group-hover:text-slate-900 transition-colors duration-300">
                  {category.title}
                </h3>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 rounded-3xl p-12 shadow-xl border border-slate-100">
